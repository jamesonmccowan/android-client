 ...
 */
public class Maps_Clipping extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_maps_clipping);
        ...
        map = ((MapFragment) getFragmentManager().findFragmentById(R.id.map_clipping)).getMap();
